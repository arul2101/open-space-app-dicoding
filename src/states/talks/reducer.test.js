...
describe('talkReducers function', () => {
  ...
  it('should return the talks when given by RECEIVE_TALKS_ACTION', () => {
    // arrange
    const initialState = [];
    const action = {
      type: 'RECEIVE_TALKS',
  ...
  it('should return the talks with the toggled like talk when given by TOGGLE_LIKE_TALK_ACTION', () => {
    // arrange
    const initialState = [
      {
        id: 'talk-1',
